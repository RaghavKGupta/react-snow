const Header = () => {
  return (
    <div>
      <header class="usa-header usa-header--basic cbxHeader">
 <div class="usa-nav-container">
    <div class="usa-navbar">
       <div class="usa-logo" id="basic-logo">
          <em class="usa-logo__text">
          <a href="javascript:void(0)" title="CBX" style={{fontSize:'32px', color:'white'}}>
          CBX<br/><span style={{fontSize:'small'}}>Children's Bureau Express</span>
          </a>
          </em>
       </div>
    ...
    <nav aria-label="Primary navigation" class="usa-nav">
       ...
       <ul class="usa-nav__primary usa-accordion">
          <li class="usa-nav__primary-item">
             ...
             <span class="nav">Current Issue</span>
             </a>
          </li>
          <li class="usa-nav__primary-item">
             <a href="javascript:void(0)" class="usa-nav__link">
             <span class="nav">Previous Issues</span>
             </a>
          </li>
          <li class="usa-nav__primary-item">
          ...
          <li class="usa-nav__primary-item">
             ...
             <span class="nav">Contact Us</span>
             </a>
          </li>
       </ul>
       <form class="usa-search usa-search--small" role="search">
          ...
          <button class="usa-button" type="submit" style={{ backgroundColor: '#63BAB0' }}>
